    ...
    , datepickerDirective = function datepickerDirective($window, $compile, $locale, $filter, $interpolate, $timeout) {
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , thisInputAddon = angular.element(element[0].querySelector('.input-group-text'))
          , theCalendar
        ...
        if (checkToggle()) {
          ...
          thisInputAddon.on('focus click focusin', function onFocusAndClick() {
        ...
        thisInputAddon.on('focusout blur', function onBlurAndFocusOut() {
          isMouseOnInput = false;
        });
