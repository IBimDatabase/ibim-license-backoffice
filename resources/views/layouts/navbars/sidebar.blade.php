    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item " ng-class="{show: ['SUPER_ADMIN', 'ADMIN'].includes(authenticatedUser.user_type)}">
                <a class="nav-link {{ Route::currentRouteName() == 'license-list' ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(), ['license-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            {{-- <li class="nav-item" ng-class="{show: ['SUPER_ADMIN', 'ADMIN'].includes(authenticatedUser.user_type)}">
                <a class="nav-link {{ Route::currentRouteName() == 'expire-report-list' ? 'active' : '' }}"
                    ...
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(), ['expire-report-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Yet to Expiry Reports</span>
                </a>
            </li> --}}
            ...
            <li class="nav-item pb-2" ng-class="{show: ['SUPER_ADMIN', 'ADMIN'].includes(authenticatedUser.user_type)}">
                <a class="nav-link {{ Route::currentRouteName() == 'role-list' ? 'active' : '' }}"
                    href="{{ route('role-list') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ in_array(request()->route()->getName(),['role-list']) ? 'text-white' : 'text-dark' }}"></i>
                    </div>
