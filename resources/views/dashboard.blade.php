          ...
          <div class="card" id="card3">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <i class="fab fa-keycdn text-lg opacity-10" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card-body p-3">
              <div class="row">
                <div class="d-flex flex-column h-100 mb-3">
                  <h5 class="font-weight-bolder">Today's Purchases</h5>
                </div>
                <div class="table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr ng-show="todayPurchasedLicenses.length == 0">
                          <td colspan="5" class="text-center text-secondary">No Data Found.</td>
                        </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="card-header pb-0">
              <div class="row">
                <div class="col-lg-6 col-7">
                  <h5 class="font-weight-bolder">This Month Purchases</h5>
                  <p class="text-sm mb-0">
                    <i class="fa fa-check text-info" aria-hidden="true"></i>
                    <span class="font-weight-bold ms-1" ng-bind="cmPurchasedLicenseCount + ' purchased'"></span> this month
                  </p>
                </div>
                <div class="col-lg-6 col-5 my-auto text-end">
                  <div class="dropdown float-lg-end pe-4">
                    <i class="fa fa-calendar text-secondary mx-2"> </i> <span ng-bind="getCurrentMonthYear"></span>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pt-4 pb-2">
              <div class="table-responsive">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">Product</th>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">License Key Count</th>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">Trial Count</th>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">Quarterly Count</th>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">Annual Count</th>
                      <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7">Life Time Count</th>
                    </tr>
                  </thead>
                  <tbody>
                      <tr ng-repeat="license in cmPurchasedLicenses">
                        <td> 
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="px-3 mb-0 text-sm" ng-bind="license.product.product_name"></h6>
                          </div>
                        </td>  
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold" ng-bind="license.license_count"></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold" ng-bind="license.trial_count"></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold" ng-bind="license.quarterly_count"></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold" ng-bind="license.annual_count"></span>
                        </td>
                        <td class="align-middle text-center text-sm">
                          <span class="text-xs font-weight-bold" ng-bind="license.life_time_count"></span>
                        </td>
                      </tr>
                      <tr ng-show="cmPurchasedLicenses.length == 0">
