                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('package_name')">
                                        Package Name <i class="fa fa-sort" aria-hidden="true"></i>
                                    </th>
                                    <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('package_code')">
                                        Package Code <i class="fa fa-sort" aria-hidden="true"></i>
                                    </th>
                                    <th class="text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('package_code')">
