...
<style>
    ...
    <div class="container-fluid py-4" ng-controller="ReportController">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4 mx-4">
                    ...
                    <div class="m-2 row date-filter">
                        <datepicker date-format="dd-MM-yyyy">
                            <input  type="text" class="form-control" ng-model="purchaseFromDateFilter" ng-change="applyDateFilter('PURCHASE')" placeholder="From...">
                        </datepicker>
                        <datepicker date-format="dd-MM-yyyy">
                            <input  type="text" class="form-control mt-1 py-2" ng-model="purchaseToDateFilter" ng-change="applyDateFilter('PURCHASE')" placeholder="To...">
                        </datepicker>
                        <button ng-class="{show: purchaseFromDateFilter && purchaseToDateFilter}" type="button" class="hide-on-load btn bg-warning mb-0 mt-1 rounded-5 w-10 text-white" ng-click="clearDateFilter('PURCHASE')">
                            Clear
                        </button>
                        <button ng-class="{show: purchaseFromDateFilter && purchaseToDateFilter && showDownload && licenselist.length > 0 && !loading}" type="button" class="hide-on-load btn bg-info mb-0 mt-1 rounded-5 w-20 text-white" ng-click="downloadExcel('PURCHASE')">
                            Download Excel
                        </button>
                    </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left text-uppercase text-info text-xs font-weight-bolder"
                                                ...
                                                <th class="text-left text-uppercase text-info text-xs font-weight-bolder"
                                                    ng-click="sortByField('purchased_date')">
                                                    Purchased Date <i class="fa fa-sort" aria-hidden="true"></i>
                                                </th>
                                                <th class="text-left text-uppercase text-info text-xs font-weight-bolder"
                                                    ng-click="sortByField('expiry_date')">
                                                    Expiry Date <i class="fa fa-sort" aria-hidden="true"></i>
                                                </th>
                                                <th
                                                    class="text-left text-uppercase text-info text-xs font-weight-bolder">
                                                    Action
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr class="data-row"
                                                ...
                                                <td class="ps-4 text-nowrap">
                                                    <span class="text-secondary text-xs font-weight-bold" ng-bind="license.order.order_placed_at | strToDate | date : 'dd-MM-y'"></span>
                                                </td>
                                                <td class="ps-4 text-nowrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-3">
                                ...
                                <div class="bg-white rounded text-dark px-2 py-2 ps-3 mh-42 border-bottom border-info">
                                    ...
                                    {{-- <i class="fas fa-eraser text-danger cursor-pointer"
                                        data-bs-toggle="modal" data-bs-target="#alertModal"
