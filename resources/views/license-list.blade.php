...
@section('content')
<div class="container-fluid py-4" ng-controller="licenseController">
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 mx-4">
                ...
                <div class="card-body px-0 pt-5 pb-2">
                    ...
                    <div class="px-4 py-2 bg-light-gray d-flex flex-row justify-content-between">
                        ...
                        <div>
                            <a href="javascript:void(0)" class="btn bg-dark mb-0 px-3 global-filter-toggle-btn mt-1 rounded-0 text-white" type="button" ng-click="globaltogglefilters()" ng-class="{show: 1}"> 
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('order_reference_no')">
                                        Order Reference No <i class="fa fa-sort" aria-hidden="true"></i>
                                    </th>
                                    <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('order_source')">
                                        Order Source <i class="fa fa-sort" aria-hidden="true"></i>
                                    </th>
                                    -->
                                    ...
                                    <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByField('expiry_date')">
                                        Expiry On <i class="fa fa-sort" aria-hidden="true"></i>
                                    </th>
                            ...
                            <tbody>
                                ...
                                <tr class="global-search-row" ng-class="{show: globalFiltersToggle}">
                                    <td colspan="4"></td>
                                    <td colspan="3">
                                        <input type="text" class="form-control" ng-model="licenseGlobalSearch" ng-change="callPaginateData()" placeholder="Search Here...">
                                    </td>
                                </tr>
                                ...
                                <tr class="data-row" ng-repeat="license in licenselist | orderBy: sortBy : reverse" ng-class="{show: licenselist}">
                                    ...
                                    <td class="ps-4">
                                        <p class="text-xs font-weight-bold mb-0" ng-bind="license.license_type | textCapitalize"></p>
                                    </td>
                                    ...
                                    <td class="ps-4">
                                        <p class="text-sm font-weight-bold text-capitalize mb-0">
                                            <span class="badge bg-gradient-warning status-badge-two" ng-if="license.status == 'AVAILABLE'" ng-bind="license.status | textCapitalize"></span>
                                            <span class="badge bg-gradient-success status-badge-two" ng-if="license.status == 'PURCHASED'" ng-bind="'Activated' | textCapitalize"></span>
                                            <span class="badge bg-gradient-danger status-badge-two" ng-if="license.status == 'EXPIRED'" ng-bind="license.status | textCapitalize"></span>
                                            <span class="badge bg-gradient-danger status-badge-two" ng-if="license.status == 'DEACTIVATED'" ng-bind="license.status | textCapitalize"></span>
                                        </p>
                                    </td>
                                    <!-- <td class="ps-4 text-nowrap">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="col">
                                            <a href="javascript:void(0);" class="me-1" ng-class="{ 'empty-div': license.status !== 'PURCHASED' }" ng-if="license.status == 'PURCHASED' && license.status != 'DEACTIVATED'" data-bs-toggle="modal" data-bs-target="#alertModal" ng-click="getLicenseId(license, '', 'DeactivateAlert'); clearFormData('deactivateLicenseForm')" title="Deactivate License">
                                                <i class="fas fa-ban text-warning"></i>
                                            </a>
                                            <a href="javascript:void(0);" class="me-1" ng-if="license.status == 'DEACTIVATED'" data-bs-toggle="modal" data-bs-target="#alertModal" ng-click="getLicenseId(license, '', 'ActivateAlert'); clearFormData('activateLicenseForm')" title="Activate License">
                                                <i class="fa fa-hand-o-right text-success"></i>
                                            </a>
                                            <a href="javascript:void(0);" class="me-1" data-bs-toggle="modal" data-bs-target="#alertModal" ng-click="getLicenseId(license, '', 'DeleteAlert'); clearFormData('deleteLicenseForm')" title="Delete License">
                                                <i class="fas fa-trash text-danger"></i>
                                            </a>
                                        </div>
                                        
                                        <div class="col">
                                            <a href="javascript:void(0);" class="me-1" data-bs-toggle="modal" data-bs-target="#renewModal" ng-click="getRenewData(license, license.product); getLicenseCodes(); clearFormData('renewForm');" ng-show="['PURCHASED', 'EXPIRED'].includes(license.status)" title="Renew License">
                                                <i class="fa fa-refresh text-primary"></i>
                                            </a>
                                            <a href="javascript:void(0);" class="me-1" data-bs-toggle="modal" data-bs-target="#alertModal" ng-click="getLicenseId(license, '', 'ResetMACAlert')" ng-show="license.status == 'PURCHASED'" title="Reset Mac License">
                    ...
                    <form name="generateLicenseForm" method="post" ng-submit="generateLicense()">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <select id="productCode" name="productCode" class="form-control" ng-model="productCode" required>
                                    <option value=""> -- Select -- </option>
                                    <optgroup label="Packages">
                                        <option ng-repeat="package in packages" value='[[ {"type": "PACKAGE", "value": package.package_code} ]]'>[[ package.package_name ]]</option>
                                    </optgroup>
                                    <optgroup label="Product Codes">
                                        <option ng-repeat="productCode in productCodes" value='[[ {"type": "PRODUCT_CODE", "value": productCode.product_code} ]]'>[[ productCode.product_name ]]</option>
                                    </optgroup>
                                </select>
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.productCode.$touched && generateLicenseForm.productCode.$invalid"> 
                                    <span ng-show="generateLicenseForm.productCode.$error.required">* The product code field is required.</span>
                                </div>
                            </div>

                            <div class="col-lg-6 mb-3">
                                <label for="licenseCode"> License Code <span class="text-warning">*</span> </label>
                                <select id="licenseCode" name="licenseCode" class="form-control" ng-model="licenseCode" required>
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.licenseCode.$touched && generateLicenseForm.licenseCode.$invalid">
                                    <span ng-show="generateLicenseForm.licenseCode.$error.required">* The license code field is required.</span>
                                </div>
                            </div>   

                            <div class="col-lg-6 mb-3">
                                <label for="counts"> Counts </label>
                                <input id="counts" type="number" name="counts" autocomplete="off" min="1" max="20" class="form-control"
                                    placeholder="Counts" ng-model="counts">
                                
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.counts.$touched && generateLicenseForm.counts.$invalid">
                                    <span ng-show="generateLicenseForm.counts.$error.required">* The counts field is required.</span>
                                </div>
                            </div> 
                            
                            <div class="col-lg-6 mb-3">
                                <label for="orderSource"> Order Source </label>
                                <select class="form-control" ng-model="orderSource" name="orderSource" id="orderSource">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.orderSource.$touched && generateLicenseForm.orderSource.$invalid">
                                    <span ng-show="generateLicenseForm.orderSource.$error.required">* The order source field is required.</span>
                                </div>
                            </div>   

                            <div class="col-lg-6 mb-3">
                                <label for="orderReferenceNo"> Order Reference No </label>
                                <input id="orderReferenceNo" type="text" name="orderReferenceNo" class="form-control"
                                    placeholder="Order Reference No" ng-model="orderReferenceNo">

                                
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.orderReferenceNo.$touched && generateLicenseForm.orderReferenceNo.$invalid">
                                    <span ng-show="generateLicenseForm.orderReferenceNo.$error.required">* The order reference no. field is required.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.orderInfo.$touched && generateLicenseForm.orderInfo.$invalid">
                                    <span ng-show="generateLicenseForm.orderInfo.$error.required">* The order info field is required.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <datepicker date-format="dd-MM-yyyy"  date-min-limit="[[ yesterdayDate ]]">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="orderTime" ng-model="orderTime" placeholder="Order Time" autocomplete="off">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.orderTime.$touched && generateLicenseForm.orderTime.$invalid">
                                    <span ng-show="generateLicenseForm.orderTime.$error.required">* The order time field is required.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.email.$touched && generateLicenseForm.email.$invalid">
                                    <span ng-show="generateLicenseForm.email.$error.required">* The email field is required.</span>
                                    <span ng-show="generateLicenseForm.email.$error.email">* The email must be a valid email address.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.firstName.$touched && generateLicenseForm.firstName.$invalid">
                                    <span ng-show="generateLicenseForm.firstName.$error.required">* The first name field is required.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.lastName.$touched && generateLicenseForm.lastName.$invalid">
                                    <span ng-show="generateLicenseForm.lastName.$error.required">* The last name field is required.</span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="generateLicenseForm.phoneNo.$touched && generateLicenseForm.phoneNo.$invalid">
                                    <span ng-show="generateLicenseForm.phoneNo.$error.required">* The phone no. field is required.</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <div class="bg-white rounded text-dark px-2 py-2 ps-3 mh-42 border-bottom border-info">
                                [[ licenseDetail.mac_address ]] <i class="fas fa-eraser text-danger cursor-pointer" data-bs-toggle="modal" data-bs-target="#alertModal" ng-click="getLicenseId(licenseDetail, ($index + 1), 'EmptyMACAlert')" ng-show="licenseDetail.mac_address" title="Reset MAC Address"></i>
                            </div>
                        </div>
                        <div class="col-md-4 mt-3">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <div class="bg-white rounded text-dark px-2 py-2 ps-3 mh-42 border-bottom border-info" ng-bind="(licenseDetail.status == 'PURCHASED') ? 'Activated' : licenseDetail.status | textCapitalize"></div>
                        </div>
                        <div class="col-md-4 mt-3">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form name="updateForm" method="post" ng-submit="updateCustomerDetails()">
                        ...
                        <input id="updateLicenseKey" type="hidden" name="updateLicenseKey" class="form-control" ng-model="updateLicenseKey">
                        <div class="row">
                            <div class="col-lg-6 mb-3">
                                <label for="productCode"> MAC Address </label>
                                <input id="updateMacAddress" type="text" name="updateMacAddress" class="form-control"
                                    placeholder="MAC Address" ng-model="updateMacAddress">
                            </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="updateForm.updateEmail.$touched && updateForm.updateEmail.$invalid">
                                    <span ng-show="updateForm.licenseCode.$error.required">* The updateEmail field is required.</span>
                                    <span ng-show="updateForm.updateEmail.$error.email">* The email must be a valid email address.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <input id="updateFirstName" type="text" name="updateFirstName" class="form-control"
                                    placeholder="first name" ng-model="updateFirstName">
                                
                                <div class="text-danger mt-1 text-xs" ng-show="updateForm.updateFirstName.$touched">
                                    <span ng-show="updateForm.updateFirstName.$error.required">* The first name field is required.</span>
                                </div>
                            </div>   
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="text-danger mt-1 text-xs" ng-show="updateForm.updateLastName.$touched">
                                    <span ng-show="updateForm.updateLastName.$error.required">* The last name field is required.</span>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-dark mb-2" ng-show="alertType == 'DeactivateAlert'">
                        ...
                        <form name="deactivateLicenseForm" method="post" ng-submit="deactivateLicense()"> 
                            <div class="col-lg-6 mb-3 mt-3" ng-show="packageFlag">
                                ...
                                <div>
                                    <input id="deactivateProductType" type="radio" name="deactivateType" ng-model="deactivateType" value="PRODUCT_CODE" ng-required="packageFlag"> <label for="deactivateProductType">Product Only</label> 
                                    <input id="deactivatePackageType" type="radio" name="deactivateType" class="ms-2" ng-model="deactivateType" value="PACKAGE" ng-required="packageFlag"> <label for="deactivatePackageType">Package</label>
                                </div>
                            </div>
                    ...
                    <div class="text-dark mb-2" ng-show="alertType == 'ResetMACAlert'">
                        ...
                        <form name="resetMacForm" method="post" ng-submit="resetMAC()">
                            <div class="col-lg-6 mb-3 mt-3" ng-show="packageFlag">
                                ...
                                <label> Deactivate <span class="text-warning">*</span> </label>
                                <div>
                                    <input id="resetProductType" type="radio" name="resetType" ng-model="resetType" value="PRODUCT" ng-required="packageFlag"> <label for="resetProductType">Product Only</label> 
                                    <input id="resetPackageType" type="radio" name="resetType" class="ms-2" ng-model="resetType" value="PACKAGE" ng-required="packageFlag"> <label for="resetPackageType">Package</label>
                                </div>
                            </div>
                            <div class="col-md-12 mt-4 pt-4 border-top text-right">
                                <button type="submit" class="btn bg-gradient-success"> Yes </button>
                    ...
                    <div class="text-dark mb-2" ng-show="alertType == 'ActivateAlert'">
                        ...
                        <form name="activateLicenseForm" method="post" ng-submit="activateLicense()"> 
                            <div class="col-lg-6 mb-3 mt-3" ng-show="packageFlag">
                                ...
                                <div>
                                    <input id="activateProductType" type="radio" name="activateType" ng-model="activateType" value="PRODUCT_CODE" ng-required="packageFlag"> <label for="activateProductType">Product Only</label> 
                                    <input id="activatePackageType" type="radio" name="activateType" class="ms-2" ng-model="activateType" value="PACKAGE" ng-required="packageFlag"> <label for="activatePackageType">Package</label>
                                </div>
                            </div>
                    ...
                    <div class="text-dark mb-2" ng-show="alertType == 'DeleteAlert'">
                        You’re about to delete the license key ([[ licenseData.hashed_license_key ]]) with the product ([[ licenseData.product.product_name ]]). To confirm, enter your password.
                        ...
                        <form name="deleteLicenseForm" method="post" ng-submit="deleteLicenseKey()"> 
                            ...
                            <div class="row">
                                <input type="hidden" name="licenseId" ng-model="licenseId">
                                <div ng-class="{'col-lg-6': packageFlag}" class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        placeholder="Password" ng-model="userPassword" ng-change="enterValue()" aria-describedby="input-addon" required>
                                ...
                                <div class="col-lg-6 mb-3" ng-show="packageFlag">
                                    ...
                                    <div>
                                        <input id="deleteProductType" type="radio" name="deleteType" ng-model="deleteType" value="PRODUCT_CODE" ng-required="packageFlag"> <label for="deleteProductType">Product Only</label> 
                                        <input id="deletePackageType" type="radio" name="deleteType" class="ms-2" ng-model="deleteType" value="PACKAGE" ng-required="packageFlag"> <label for="deletePackageType">Package</label>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 mt-4 pt-4 border-top text-right" ng-show="alertType != 'DeleteAlert' && alertType != 'DeactivateAlert' && alertType != 'ActivateAlert' && alertType != 'ResetMACAlert'">
                        <button type="submit" class="btn bg-gradient-success" ng-click="(alertType == 'EmptyMACAlert') ? resetMACAddress(licenseId) : (alertType == 'ActivateAlert') ? activateLicense(licenseId) : deactivateLicense(licenseId)"> Yes </button>
                        <button type="button" class="btn bg-gradient-warning" data-bs-dismiss="modal"> No </button>
                    </div>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-info text-xs font-weight-bolder opacity-7" ng-click="sortByHistoryField('system_info')">
                        ...
                        <tbody>
                            <tr ng-repeat="licenseHistory in licenseHistoryData | orderBy: sortByHistory: reverseHistory">
                                ...
                                <td ng-bind="(licenseHistory.entry_type) ? licenseHistory.entry_type : 'MAC Address Update' | textCapitalize : (licenseHistory.entry_type == 'MAC_ADDRESS_UPDATE' || !licenseHistory.entry_type) ? 1 : ''"></td>
                                ...
                                <td class="pe-4" ng-bind="licenseHistory.created_at | strToDate | date : 'dd-MM-y hh:mm:ss a'"></td>
                            </tr>
    ...
    <span id="generatedLicenseKeysModalBtn" data-bs-toggle="modal" data-bs-target="#generatedLicenseKeysModal"></span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <i class="fas fa-copy text-primary copy-text cursor-pointer" ng-click="copyToClipboard($event.target, 'generatedLicenseKeys')" title="Copy"> Copy License Key(s)</i>
