                ...
                <div class="card mb-4 mx-4">
                    ...
                    <div class="m-2 row date-filter">
                        <datepicker date-format="dd-MM-yyyy">
                            <input  type="text" class="form-control" ng-model="expiryFromDateFilter" ng-change="applyDateFilter('EXPIRE')" placeholder="From...">
                        </datepicker>
                        <datepicker date-format="dd-MM-yyyy">
                            <input  type="text" class="form-control mt-1 py-2" ng-model="expiryToDateFilter" ng-change="applyDateFilter('EXPIRE')" placeholder="To...">
                        </datepicker>
                        <button ng-class="{show: expiryFromDateFilter && expiryToDateFilter}" type="button" class="hide-on-load btn bg-warning mb-0 mt-1 rounded-5 w-10 text-white" ng-click="clearDateFilter('EXPIRE')">
                            Clear
                        </button>
                        <button ng-class="{show: expiryFromDateFilter && expiryToDateFilter && showDownload && licenselist.length > 0 && !loading}" type="button" class="hide-on-load btn bg-info mb-0 mt-1 rounded-5 w-20 text-white" ng-click="downloadExcel('EXPIRE')">
                            Download Excel
                        </button>
                    </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-left text-uppercase text-info text-xs font-weight-bolder opacity-7"
                                                    ng-click="sortByField('puchased_date')">
                                                    Purchased Date <i class="fa fa-sort" aria-hidden="true"></i>
                                                </th>
                                                <th class="text-left text-uppercase text-info text-xs font-weight-bolder opacity-7"
                                                    ng-click="sortByField('expiry_date')">
                                                    Expired Date <i class="fa fa-sort" aria-hidden="true"></i>
                                                </th>
                                                <th
